...
$(document).ready(() => {
  const links = [
    {
      name: 'Discord',
      link: 'https://discord.gg/vKQaRV6fpM',
    },
    {
      name: 'Roblox',
      link: 'https://www.roblox.com/users/460101494/profile',
    },
    {
      name: 'Youtube',
      link: 'https://www.youtube.com/channel/UCgWSK3-MrrrwwvvulmQn_5w',
    },
    {
      name: 'Steam',
      link: 'shit.com',
  ...
  app.titleChanger(['Kixxer', 'Retard', 'Anime', 'Sm00thBrain','gamer',''])
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Checking your ip to make sure your a real retard', "No smart brain detected redirecting! Redirecting <span style='font-size: 14px; color: #06d;'>[Success]</span>..."], 10, () => {
    ...
    writeLine([`Hey crackhead! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `We have checked, <i style='color: #0f0'>${ip}</i>! also we detected you live in ${country} here!`], 30, 30, () => {
      ...
      writeLine([`<i style='color: #F62459'>Kixxer Enjoy!</i>`], 10, 40, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
